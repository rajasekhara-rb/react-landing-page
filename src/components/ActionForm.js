...
function ActionForm() {
    return (
        <>
            <section className="call-to-action text-white text-center p-5" id="signup" style={{ backgroundImage: "url(https://c4.wallpaperflare.com/wallpaper/93/762/482/blue-water-aqua-turquoise-wallpaper-preview.jpg)" }}>
