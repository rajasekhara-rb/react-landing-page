...
const Header = () => {
    return (
        <>
            <header className="masthead bg-dark p-5" style={{ backgroundImage: "url(https://c4.wallpaperflare.com/wallpaper/93/762/482/blue-water-aqua-turquoise-wallpaper-preview.jpg)"}}>
